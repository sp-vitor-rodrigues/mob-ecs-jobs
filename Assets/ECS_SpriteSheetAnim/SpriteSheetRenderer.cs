...
public class SpriteSheetRenderer : ComponentSystem {
    ...
    protected override void OnUpdate()
    {
        ...
        for (int i = 0; i < POSITION_SLICES; i++) {
            visibleEntityTotal += GameController.Instance.SlicePositionData[i].PositionsData.Length;
        }
        ...
        for (int i = 0; i < POSITION_SLICES; i++)
        {
            ...
            if (GameController.Instance.SlicePositionData[i].DataChanged)
            {
                var positionsData = GameController.Instance.SlicePositionData[i].PositionsData;
                ...
                GameController.Instance.SlicePositionData[i].DataChanged = false;
            }
        }
